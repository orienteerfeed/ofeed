...
import {
  ...
  buildCSPDirectives,
  buildCSPHeaderValue,
  buildOpenApiReferenceCSPDirectives,
  buildOpenApiReferenceCSPHeaderValue,
  isCSPEnabled,
  SCALAR_CSP_SCRIPT_SOURCE,
} from '../security.js';
...
describe('config/security', () => {
  ...
  it('extends OpenAPI reference CSP with the Scalar CDN', () => {
    const directives = buildOpenApiReferenceCSPDirectives('production', 'abc123');
