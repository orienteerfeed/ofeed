...
export const EVENT_OPENAPI_PATHS: Record<string, OpenApiPathItem> = {
  ...
  [`${eventsBase}/{eventId}/czech-ranking`]: {
    post: {
      tags: [EVENT_OPENAPI.tag],
      operationId: 'eventCzechRankingRecalculate',
      summary: 'Recalculate Czech ranking for event',
      security: [],
      parameters: [eventIdParam],
      responses: {
        200: okJson('Czech ranking recalculated'),
      },
    },
  },
